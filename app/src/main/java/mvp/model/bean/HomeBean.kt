    ...
    data class Issue(var count: Int, val date: Long, val itemList: ArrayList<Item>, val publishTime: Long, val releaseTime: Long, val type: String) {
        ...
        data class Item(val adIndex: Int, val data: Data, val id: Int, val type: String) : Serializable {
            ...
            data class Data(
                ...
                data class Author(val approvedNotReadyVideoCount: Int,
                                  val description: String,
                                  val follow: Follow,
                                  val icon: String,
                                  val id: Int,
                ...
                data class Provider(val alias: String, val icon: String, val name: String) : Serializable

                data class Tag(val actionUrl: String,
